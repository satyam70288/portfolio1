  ...
  return (
    ...
    <div className="about" id="about">
        <div className="row">
            ...
            <h1> About me</h1>
            <p >  often abbreviated as JS, is a programming language that is one of the core technologies of the World Wide Web, alongside HTML and CSS. As of 2023, 98.7% of websites use JavaScript on the client side for webpage such as networking, storage, or graphics facilities. In practice, the web browser or othertive standard libraries, the two languages are distinct and differ greatly in design.
